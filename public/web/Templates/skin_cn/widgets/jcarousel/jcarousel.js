		...
		jcarousel
			.on('jcarousel:reload jcarousel:create', function (event, carousel) {
				 ...
				 if ( responsive.getType()==='Pc') {
					  width = width / numPc;
				 } else if(responsive.getType()==='Pad'){
					  width = width / numPad;
				 } else {
