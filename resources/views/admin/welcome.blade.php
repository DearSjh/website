                    ...
                    <ul class="clearfix">
                        ...
                        <li class="col-sm-12 col-md-4 col-xs-12">
                            <a href="javascript:;" class="clearfix">
                                ...
                                <div class="right-text-con">
                                    <p class="name">文章数</p>
                                    <p><span class="color-blue">{{GetMessage()['article']}}</span>数据<span class="iconfont">&#xe628;</span></p>
                                </div>
                            </a>
                        </li>
                        <li class="col-sm-12 col-md-4 col-xs-12">
                            <a href="javascript:;" class="clearfix">
                                ...
                                <div class="right-text-con">
                                    <p class="name">评论数</p>
                                    <p><span class="color-green">{{GetMessage()['message']}}</span>数据<span class="iconfont">&#xe60f;</span></p>
                                </div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="panel-body">
                        <div class="commentbox">
                            <ul class="commentList">
                                @foreach(GetMessageList() as $message)
                                <li class="item cl"><a href="#"><i class="avatar size-L radius"><img alt="" src=""></i></a>
                                    <div class="comment-main">
                                        <header class="comment-header">
                                            <div class="comment-meta"><a class="comment-author" href="#">{{$message['name']}}</a> 评论于
                                                <time title="{{$message['created_at']}}" datetime="{{$message['created_at']}}">{{$message['created_at']}}
                                                </time>
                                            </div>
                                        </header>
                                        <div class="comment-body">
                                            <p><a href="#">@</a> {{$message['content']}}</p>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
