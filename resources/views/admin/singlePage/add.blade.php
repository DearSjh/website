                ...
                <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-input-inline">
                            <select name="category_id" id="category_id" lay-verify="category_id">
                                ...
                                @foreach($category as $value)
                                    <option value="{{ $value['id'] }}" @if(count($value['child']) > 0)  @endif>{{ $value['name'] }}</option>
                                    @foreach($value['child'] as $child)
                                        <option value="{{ $child['id'] }}" @if(count($child['child']) > 0)  @endif>&nbsp;├ {{ $child['name'] }}</option>
                                    @endforeach
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="layui-form-item">
                        <label for="abstract" class="layui-form-label">
                            摘要、描述</label>
                        <div class="layui-input-inline">
                            <textarea rows="5" cols="90" id="abstract" name="abstract"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="keyword" class="layui-form-label">
                            关键字</label>
                        <div class="layui-input-inline">
                            <textarea rows="4" cols="80" id="keyword" name="keyword"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
