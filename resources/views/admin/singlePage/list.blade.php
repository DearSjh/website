            ...
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal go-btn hidden-xs"
                            data-url="/admin/singlePage/add"><i class="layui-icon">&#xe654;</i></button>
                </div>
                        ...
                        <td>
                            <div class="layui-inline">
                                <button class="layui-btn layui-btn-mini layui-btn-normal  go-btn"
                                        data-id="{{ $value['id'] }}"
                                        data-url="/admin/singlePage/edit/{{ $value['id'] }}"><i
                                            class="layui-icon">&#xe642;</i>
                                </button>
    ...
    <script>
        ...
        layui.use(['form', 'jquery', 'layer', 'dialog'], function () {
            ...
            $('#table-list').on('click', '.table-list-status', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '/admin/singlePage/status/' + id,
