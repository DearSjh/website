            ...
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal go-btn hidden-xs"
                            data-url="/admin/banner/add"><i class="layui-icon">&#xe654;</i></button>
                </div>
        ...
        <div class="layui-form" id="table-list">
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    <th class="hidden-xs" style="width: 200px;">标题</th>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(!empty( $value['picture']))
                                <img src="{{ $value['picture'] }}" width="300px;" height="150px;">
                            @endif
                        </td>
                        ...
                        <td>
                            <div class="layui-inline">
                                <button class="layui-btn layui-btn-mini layui-btn-normal  go-btn"
                                        data-id="{{ $value['id'] }}" data-url="/admin/banner/edit/{{ $value['id'] }}"><i
                                            class="layui-icon">&#xe642;</i>
                                </button>
