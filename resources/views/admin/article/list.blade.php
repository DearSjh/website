            ...
            <div class="layui-form-item">
                <div class="layui-inline tool-btn">
                    <button class="layui-btn layui-btn-small layui-btn-normal go-btn hidden-xs"
                            data-url="/admin/article/add"><i class="layui-icon">&#xe654;</i>
                    </button>
                </div>
        ...
        <div class="layui-form" id="table-list">
            <table class="layui-table" lay-even lay-skin="nob">
                ...
                <tr>
                    ...
                    <th style="width: 300px;">所属分类</th>
                    <th style="width: 300px;">发布状态</th>
                        ...
                        <td>
                            @if($value['is_release'] == 1)
                                <button class="layui-btn layui-btn-mini layui-btn-normal table-list-status"
                                        data-id='{{ $value['id'] }}' data-status='{{ $value['is_release'] }}'>开启
                                </button>
                            @else
                                <button class="layui-btn layui-btn-mini layui-btn-warm table-list-status"
                                        data-status='{{ $value['is_release'] }}' data-id='{{ $value['id'] }}'>停用
                                </button>
                            @endif
                        </td>
                        ...
                        <td>
                            <div class="layui-inline">
                                <button class="layui-btn layui-btn-mini layui-btn-normal  go-btn"
                                        data-id="{{ $value['id'] }}" data-url="/admin/article/edit/{{ $value['id'] }}">
                                    <i
                                            class="layui-icon">&#xe642;</i>
                                </button>
