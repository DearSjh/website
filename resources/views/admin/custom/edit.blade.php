    ...
    <form class="layui-form column-content-detail">
        <div class="layui-tab">
            <ul class="layui-tab-title">
                ...
                <li class="layui-this">修改自定义数据</li>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" style="width: 300px;" lay-verify="required"
                                   placeholder="请输入标题" value="{{ $custom['name'] }}"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <textarea rows="5" cols="90" id="abstract"
                                      name="abstract">{{ $custom['value'] }}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="hidden" id="i_main_pic" name="main_pic" value="{{ $custom['main_pic'] }}">
                            <img id="main_pic" src="{{ $custom['main_pic'] }}"
                                 style="margin-top: 20px; width: 100px;  @if(empty($custom['main_pic'])) display: none @endif">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            @if(!empty($custom['group_pic']))
                                @foreach(explode(',', $custom['group_pic']) as $value)
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="link" name="link" required="" lay-verify="link"
                                   autocomplete="off" class="layui-input" value="{{ $custom['link'] }}"></div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <div class="layui-input-inline">
                                <input type="radio" name="state" value="0" title="否"
                                       @if($custom['state'] == 0) checked @endif>
                                <input type="radio" name="state" value="1" title="是"
                                       @if($custom['state'] == 1) checked @endif>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="sort" name="sort" required="" lay-verify="sort"
                                   autocomplete="off" class="layui-input" value="{{ $custom['sort'] }}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="hidden" id="i_file" name="file" value="{{ $custom['file'] }}">
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <script id="container" name="content"
                                    type="text/plain">{!! $custom['content']  !!}</script>
                        </div>
                    </div>
                </div>
            </div>
